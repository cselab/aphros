...
#SBATCH --job-name=single_bubble             # job name
#SBATCH --ntasks=64                    # number of tasks
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=8
#SBATCH --time=01:00:00                # rum time hours:minutes:seconds
#SBATCH --output=single_bubble_jobID-%j.out  # output file name
#SBATCH --error=single_bubble_jobID-%j.err   # error file name
...
-sim cloud -restart 0 \
-bpdx 3 -bpdy 3 -bpdz 3 -xpesize 4 -ypesize 4 -zpesize 4 -extent 0.6 \
