...
install(FILES CubismNoCopy/BlockInfo.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/BlockLab.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/BlockLabMPI.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/DependencyCubeMPI.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/Grid.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/GridMPI.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/HDF5Dumper_MPI.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/Matrix3D.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/PUPkernelsMPI.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/QPXEMU.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/StencilInfo.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
install(FILES CubismNoCopy/SynchronizerMPI.h DESTINATION ${CHPREFIX}/include/hydro/CubismNoCopy)
...
install(FILES debug/cond.h DESTINATION ${CHPREFIX}/include/hydro/debug)
install(FILES debug/isnan.h DESTINATION ${CHPREFIX}/include/hydro/debug)
install(FILES debug/linear.h DESTINATION ${CHPREFIX}/include/hydro/debug)
install(FILES distr/cubism.h DESTINATION ${CHPREFIX}/include/hydro/distr)
install(FILES distr/cubismnc.h DESTINATION ${CHPREFIX}/include/hydro/distr)
install(FILES distr/distrbasic.h DESTINATION ${CHPREFIX}/include/hydro/distr)
...
install(FILES dump/hdf.h DESTINATION ${CHPREFIX}/include/hydro/dump)
...
install(FILES func/init_bc.h DESTINATION ${CHPREFIX}/include/hydro/func)
install(FILES func/init_cl.h DESTINATION ${CHPREFIX}/include/hydro/func)
install(FILES func/init_contang.h DESTINATION ${CHPREFIX}/include/hydro/func)
install(FILES func/init.h DESTINATION ${CHPREFIX}/include/hydro/func)
...
install(FILES geom/filter.h DESTINATION ${CHPREFIX}/include/hydro/geom)
...
install(FILES geom/notation.h DESTINATION ${CHPREFIX}/include/hydro/geom)
...
install(FILES geom/transform.h DESTINATION ${CHPREFIX}/include/hydro/geom)
install(FILES geom/unique.h DESTINATION ${CHPREFIX}/include/hydro/geom)
...
install(FILES kernel/hydro_snippets.h DESTINATION ${CHPREFIX}/include/hydro/kernel)
...
install(FILES linear/hypresub.h DESTINATION ${CHPREFIX}/include/hydro/linear)
...
install(FILES parse/argparse.h DESTINATION ${CHPREFIX}/include/hydro/parse)
install(FILES parse/codeblocks.h DESTINATION ${CHPREFIX}/include/hydro/parse)
install(FILES parse/config.h DESTINATION ${CHPREFIX}/include/hydro/parse)
install(FILES parse/curv.h DESTINATION ${CHPREFIX}/include/hydro/parse)
install(FILES parse/parser.h DESTINATION ${CHPREFIX}/include/hydro/parse)
install(FILES parse/proj.h DESTINATION ${CHPREFIX}/include/hydro/parse)
install(FILES parse/simple.h DESTINATION ${CHPREFIX}/include/hydro/parse)
install(FILES parse/solver.h DESTINATION ${CHPREFIX}/include/hydro/parse)
...
install(FILES solver/approx_eb.h DESTINATION ${CHPREFIX}/include/hydro/solver)
...
install(FILES solver/convdiffv_eb.h DESTINATION ${CHPREFIX}/include/hydro/solver)
install(FILES solver/convdiffvg.h DESTINATION ${CHPREFIX}/include/hydro/solver)
install(FILES solver/convdiffv.h DESTINATION ${CHPREFIX}/include/hydro/solver)
install(FILES solver/curv.h DESTINATION ${CHPREFIX}/include/hydro/solver)
install(FILES solver/electro.h DESTINATION ${CHPREFIX}/include/hydro/solver)
install(FILES solver/embed.h DESTINATION ${CHPREFIX}/include/hydro/solver)
install(FILES solver/fluid_dummy.h DESTINATION ${CHPREFIX}/include/hydro/solver)
...
install(FILES solver/particles.h DESTINATION ${CHPREFIX}/include/hydro/solver)
...
install(FILES solver/proj.h DESTINATION ${CHPREFIX}/include/hydro/solver)
...
install(FILES solver/tracer.h DESTINATION ${CHPREFIX}/include/hydro/solver)
install(FILES solver/tracker.h DESTINATION ${CHPREFIX}/include/hydro/solver)
install(FILES solver/trackerm.h DESTINATION ${CHPREFIX}/include/hydro/solver)
...
install(FILES util/compressor.h DESTINATION ${CHPREFIX}/include/hydro/util)
...
install(FILES util/filesystem.h DESTINATION ${CHPREFIX}/include/hydro/util)
...
install(FILES util/histogram.h DESTINATION ${CHPREFIX}/include/hydro/util)
install(FILES util/hydro.h DESTINATION ${CHPREFIX}/include/hydro/util)
install(FILES util/linear.h DESTINATION ${CHPREFIX}/include/hydro/util)
install(FILES util/logger.h DESTINATION ${CHPREFIX}/include/hydro/util)
install(FILES util/metrics.h DESTINATION ${CHPREFIX}/include/hydro/util)
install(FILES util/module.h DESTINATION ${CHPREFIX}/include/hydro/util)
install(FILES util/posthook.h DESTINATION ${CHPREFIX}/include/hydro/util)
install(FILES util/stat.h DESTINATION ${CHPREFIX}/include/hydro/util)
install(FILES util/subcomm.h DESTINATION ${CHPREFIX}/include/hydro/util)
