...
s_00Display.DataAxesGrid.XTitleColor = [0.0, 0.0, 0.0]
s_00Display.DataAxesGrid.XTitleFontFile = ''
s_00Display.DataAxesGrid.YTitleColor = [0.0, 0.0, 0.0]
s_00Display.DataAxesGrid.YTitleFontFile = ''
s_00Display.DataAxesGrid.ZTitleColor = [0.0, 0.0, 0.0]
s_00Display.DataAxesGrid.ZTitleFontFile = ''
s_00Display.DataAxesGrid.GridColor = [0.0, 0.0, 0.0]
s_00Display.DataAxesGrid.XLabelColor = [0.0, 0.0, 0.0]
s_00Display.DataAxesGrid.XLabelFontFile = ''
s_00Display.DataAxesGrid.YLabelColor = [0.0, 0.0, 0.0]
s_00Display.DataAxesGrid.YLabelFontFile = ''
s_00Display.DataAxesGrid.ZLabelColor = [0.0, 0.0, 0.0]
s_00Display.DataAxesGrid.ZLabelFontFile = ''

# init the 'PolarAxesRepresentation' selected for 'PolarAxes'
s_00Display.PolarAxes.PolarAxisTitleColor = [0.0, 0.0, 0.0]
s_00Display.PolarAxes.PolarAxisTitleFontFile = ''
s_00Display.PolarAxes.PolarAxisLabelColor = [0.0, 0.0, 0.0]
s_00Display.PolarAxes.PolarAxisLabelFontFile = ''
s_00Display.PolarAxes.LastRadialAxisTextColor = [0.0, 0.0, 0.0]
s_00Display.PolarAxes.LastRadialAxisTextFontFile = ''
s_00Display.PolarAxes.SecondaryRadialAxesTextColor = [0.0, 0.0, 0.0]
