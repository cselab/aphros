...
contour2.Isosurfaces = [-1.0, 1.0, -3.0, 3.0]
...
vorticityLUT.RGBPoints = [-3.0, 0.231373, 0.298039, 0.752941, -1.06097567081451, 0.501960784313725, 0.63921568627451, 0.980392156862745, 8.88178419700125e-16, 0.865003, 0.865003, 0.865003, 0.878048658370972, 0.917647058823529, 0.486274509803922, 0.376470588235294, 3.0, 0.705882, 0.0156863, 0.14902]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
contour2Display.ScaleTransferFunction.Points = [-0.55019657610129, 0.0, 0.5, 0.0, 0.499082824020939, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
contour2Display.OpacityTransferFunction.Points = [-0.55019657610129, 0.0, 0.5, 0.0, 0.499082824020939, 1.0, 0.5, 0.0]
...
vorticityPWF.Points = [-3.0, 0.703947365283966, 0.5, 0.0, 0.0, 0.0, 0.5, 0.0, 3.0, 0.657894730567932, 0.5, 0.0]
