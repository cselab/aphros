...
clpntDisplay.OSPRayScaleArray = 'vf'
...
clpntDisplay.SelectScaleArray = 'vf'
clpntDisplay.GlyphType = 'Arrow'
clpntDisplay.GlyphTableIndexArray = 'vf'
clpntDisplay.GaussianRadius = 0.015
clpntDisplay.SetScaleArray = ['POINTS', 'vf']
clpntDisplay.ScaleTransferFunction = 'PiecewiseFunction'
clpntDisplay.OpacityArray = ['POINTS', 'vf']
