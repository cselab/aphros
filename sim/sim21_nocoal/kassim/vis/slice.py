...
renderView1.ViewSize = [512,400]
renderView1.OrientationAxesVisibility = 0
renderView1.CameraPosition =\
[0.025203149389963972, 0.02542980040896667, 0.12292691273922375]
renderView1.CameraFocalPoint =\
[0.025203149389963972, 0.02542980040896667, 0.02500000037252903]
renderView1.CameraViewUp =\
[0.0, 1.0, 0.0]
renderView1.CameraParallelScale = 0.0119196202676
...
clip1.Crinkleclip = 1
clip1.ClipType.Origin = [0.0, 0.001, 0.0]
...
slice1.SliceType.Origin = [0.025, 0.025, 0.025]
...
slice1Display.DiffuseColor = [0.]*3
slice1Display.AmbientColor = [0.]*3
