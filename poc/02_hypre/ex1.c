...
int main(int argc, char* argv[]) {
  ...
  /* 3. Set up a Struct Matrix */
  {
    ...
    if (myid == 0) {
      int ilower[2] = {-3, 1}, iupper[2] = {-1, 2};
      int stencil_indices[5] = {0, 1, 2, 3, 4}; /* labels for the stencil
                                                   entries - these correspond to
                                                   the offsets defined above */
      int nentries = 5;
      ...
      HYPRE_StructMatrixSetBoxValues(
          A, ilower, iupper, nentries, stencil_indices, values);
    } else if (myid == 1) {
      int ilower[2] = {0, 1}, iupper[2] = {2, 4};
    ...
    if (myid == 0) {
        ...
        values[i] = 0.0;
      {
        ...
        HYPRE_StructMatrixSetBoxValues(
            A, ilower, iupper, 1, stencil_indices, values);
      }
      {
