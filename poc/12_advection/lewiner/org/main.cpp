    ...
    for (int j = 0; j < mc.size_y(); j++) {
      ...
      for (int i = 0; i < mc.size_x(); i++) {
        ...
        mc.set_data(
            (float)(
                // cushin
                //            z*z*x*x - z*z*z*z - 2*z*x*x + 2*z*z*z + x*x - z*z
                //            - (x*x - z)*(x*x - z) - y*y*y*y - 2*x*x*y*y -
                //            y*y*z*z + 2*y*y*z + y*y ,
                // sphere
                ...
                //            x+y+z -3,
                // cassini
                //            (x*x + y*y + z*z + 0.45f*0.45f)*(x*x + y*y + z*z +
                //            0.45f*0.45f) - 16*0.45f*0.45f*(x*x + z*z) -
                //            0.5f*0.5f ,
                // blooby
                //           x*x*x*x - 5*x*x+ y*y*y*y - 5*y*y + z*z*z*z - 5*z*z
                //           + 11.8 ),
                //  chair
                //            x*x+y*y+z*z-0.95f*25)*(x*x+y*y+z*z-0.95f*25)-0.8f*((z-5)*(z-5)-2*x*x)*((z+5)*(z+5)-2*y*y
                //            ,
                // cyclide
                //            ( x*x + y*y + z*z + b*b - d*d ) * ( x*x + y*y +
                //            z*z + b*b - d*d ) - 4 * ( ( a*x - c*d ) * ( a*x -
                //            c*d ) + b*b * y*y ),
                // 2 torus
                ((x * x + y * y + z * z + R * R - r * r) *
                     (x * x + y * y + z * z + R * R - r * r) -
            ...
            // + 24.1201*(1-x)*(1-y)*  z   - 74.4702*x*(1-y)*  z + 91.5298*x*y*
            // z  - 3.22998*(1-x)*y*  z  ), Drip
            //          x*x + y*y - 0.5*( 0.995*z*z + 0.005 - z*z*z ) +0.0025 ),
            //          // -0.0754+0.01, -0.0025 + 0.01, grid 40^3, [-1.5,1.5]
