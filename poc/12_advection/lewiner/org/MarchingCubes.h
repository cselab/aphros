...
//-----------------------------------------------------------------------------
{
 ...
 public:
   ...
   */
  MarchingCubes(
      const int size_x = -1, const int size_y = -1, const int size_z = -1);
  /** Destructor */
  ~MarchingCubes();
 ...
 public:
  ...
  inline const int nverts() const {
    return _nverts;
  }
  /** accesses the number of triangles of the generated mesh */
  inline const int ntrigs() const {
    return _ntrigs;
  }
 ...
 protected:
   ...
   * cubes edges \param iso isovalue
   */
   ...
   * vertex of the specified cube \param i abscisse of the cube \param j
   * ordinate of the cube \param k height of the cube
   */
   ...
   * lower vertex of the specified cube \param i abscisse of the cube \param j
   * ordinate of the cube \param k height of the cube
   */
   ...
   * specific cube \param i abscisse of the cube \param j ordinate of the cube
   * \param k height of the cube
   */
   ...
   * specific cube \param val the index of the new vertex \param i abscisse of
   * the cube \param j ordinate of the cube \param k height of the cube
   */
   ...
   * cube \param val the index of the new vertex \param i abscisse of the cube
   * \param j ordinate of the cube
   * \param k height of the cube
   */
 ...
 protected:
  bool _originalMC; /**< selects wether the algorithm will use the enhanced
                       ...
                       MarchingCubes */
  bool _ext_data; /**< selects wether to allocate data or use data from another
                     class */
  ...
  int* _x_verts; /**< pre-computed vertex indices on the lower horizontal   edge
                    of each cube */
  int* _y_verts; /**< pre-computed vertex indices on the lower longitudinal edge
                    of each cube */
  int* _z_verts; /**< pre-computed vertex indices on the lower vertical     edge
                    of each cube */
