...
static const char confsizes[15] = {2, 16, 24, 24, 8,  48, 48, 16,
                                   6, 8,  6,  12, 24, 2,  12};

static const char subcasesizes[15] = {1, 1, 1, 2, 2, 1,  3, 9,
                                      1, 1, 5, 1, 5, 50, 1};
...
//-----------------------------------------------------------------------------
{
  ...
  if (glIsList(gllist) == GL_TRUE) glDeleteLists(gllist, 1);

  if ((gllist = glGenLists(1)) == 0) return;
  ...
  glNewList(gllist, GL_COMPILE);
  {
    ...
    switch (m_case) {
      ...
      case 3:
        switch (m_subcase) {
          case 0:
            ...
            draw_triangle(tiling3_2[m_config], 4);
            break;
          case 1:
            if (test3[m_config] < 0) mark_face(-test3[m_config]);
            draw_triangle(tiling3_1[m_config], 2);
            break;
        };
        break;
      ...
      case 4:
        switch (m_subcase) {
          case 0:
            ...
            draw_triangle(tiling4_1[m_config], 2);
            break;
          case 1:
            if (test4[m_config] > 0) mark_face(test4[m_config]);
            draw_triangle(tiling4_2[m_config], 6);
            break;
        };
        break;
      ...
      case 6:
        switch (m_subcase) {
          case 0:
            ...
            draw_triangle(tiling6_2[m_config], 5);
            break;
          case 1:
            if (test6[m_config][0] < 0) mark_face(-test6[m_config][0]);
            if (test6[m_config][1] < 0) mark_face(-test6[m_config][1]);
            draw_triangle(tiling6_1_1[m_config], 3);
            break;
          case 2:
            if (test6[m_config][0] < 0) mark_face(-test6[m_config][0]);
            if (test6[m_config][1] > 0) mark_face(test6[m_config][1]);
            draw_triangle(tiling6_1_2[m_config], 9);
            break;
        };
        break;
      ...
      case 7:
        switch (m_subcase) {
          case 0:
            ...
            draw_triangle(tiling7_4_1[m_config], 5);
            break;
          case 1:
            if (test7[m_config][0] > 0) mark_face(test7[m_config][0]);
            if (test7[m_config][1] > 0) mark_face(test7[m_config][1]);
            if (test7[m_config][2] > 0) mark_face(test7[m_config][2]);
            if (test7[m_config][3] < 0) mark_face(-test7[m_config][3]);
            draw_triangle(tiling7_4_2[m_config], 9);
            break;
          case 2:
            if (test7[m_config][0] > 0) mark_face(test7[m_config][0]);
            if (test7[m_config][1] > 0) mark_face(test7[m_config][1]);
            if (test7[m_config][2] < 0) mark_face(-test7[m_config][2]);
            draw_triangle(tiling7_3[m_config][0], 9);
            break;
          case 3:
            if (test7[m_config][0] > 0) mark_face(test7[m_config][0]);
            if (test7[m_config][1] < 0) mark_face(-test7[m_config][1]);
            if (test7[m_config][2] > 0) mark_face(test7[m_config][2]);
            draw_triangle(tiling7_3[m_config][1], 9);
            break;
          case 4:
            if (test7[m_config][0] < 0) mark_face(-test7[m_config][0]);
            if (test7[m_config][1] > 0) mark_face(test7[m_config][1]);
            if (test7[m_config][2] > 0) mark_face(test7[m_config][2]);
            draw_triangle(tiling7_3[m_config][2], 9);
            break;
          case 5:
            if (test7[m_config][0] > 0) mark_face(test7[m_config][0]);
            if (test7[m_config][1] < 0) mark_face(-test7[m_config][1]);
            if (test7[m_config][2] < 0) mark_face(-test7[m_config][2]);
            draw_triangle(tiling7_2[m_config][0], 5);
            break;
          case 6:
            if (test7[m_config][0] < 0) mark_face(-test7[m_config][0]);
            if (test7[m_config][1] > 0) mark_face(test7[m_config][1]);
            if (test7[m_config][2] < 0) mark_face(-test7[m_config][2]);
            draw_triangle(tiling7_2[m_config][1], 5);
            break;
          case 7:
            if (test7[m_config][0] < 0) mark_face(-test7[m_config][0]);
            if (test7[m_config][1] < 0) mark_face(-test7[m_config][1]);
            if (test7[m_config][2] > 0) mark_face(test7[m_config][2]);
            draw_triangle(tiling7_2[m_config][2], 5);
            break;
          case 8:
            if (test7[m_config][0] < 0) mark_face(-test7[m_config][0]);
            if (test7[m_config][1] < 0) mark_face(-test7[m_config][1]);
            if (test7[m_config][2] < 0) mark_face(-test7[m_config][2]);
            draw_triangle(tiling7_1[m_config], 3);
            break;
        };
        break;
      ...
      case 10:
        switch (m_subcase) {
          case 0:
            ...
            draw_triangle(tiling10_2[m_config], 8);
            break;
          case 1:
            if (test10[m_config][0] < 0) mark_face(-test10[m_config][0]);
            if (test10[m_config][1] > 0) mark_face(test10[m_config][1]);
            draw_triangle(tiling10_2_[m_config], 8);
            break;
          case 2:
            if (test10[m_config][0] < 0) mark_face(-test10[m_config][0]);
            if (test10[m_config][1] < 0) mark_face(-test10[m_config][1]);
            if (test10[m_config][2] < 0) mark_face(-test10[m_config][2]);
            draw_triangle(tiling10_1_1[m_config], 4);
            break;
          case 3:
            if (test10[m_config][0] > 0) mark_face(test10[m_config][0]);
            if (test10[m_config][1] > 0) mark_face(test10[m_config][1]);
            draw_triangle(tiling10_1_1_[m_config], 4);
            break;
          case 4:
            if (test10[m_config][0] < 0) mark_face(-test10[m_config][0]);
            if (test10[m_config][1] < 0) mark_face(-test10[m_config][1]);
            if (test10[m_config][2] > 0) mark_face(test10[m_config][2]);
            draw_triangle(tiling10_1_2[m_config], 8);
            break;
        };
        break;
      ...
      case 12:
        switch (m_subcase) {
          case 0:
            ...
            draw_triangle(tiling12_2[m_config], 8);
            break;
          case 1:
            if (test12[m_config][0] < 0) mark_face(-test12[m_config][0]);
            if (test12[m_config][1] > 0) mark_face(test12[m_config][1]);
            draw_triangle(tiling12_2_[m_config], 8);
            break;
          case 2:
            if (test12[m_config][0] < 0) mark_face(-test12[m_config][0]);
            if (test12[m_config][1] < 0) mark_face(-test12[m_config][1]);
            if (test12[m_config][2] < 0) mark_face(-test12[m_config][2]);
            draw_triangle(tiling12_1_1[m_config], 4);
            break;
          case 3:
            if (test12[m_config][0] > 0) mark_face(test12[m_config][0]);
            if (test12[m_config][1] > 0) mark_face(test12[m_config][1]);
            draw_triangle(tiling12_1_1_[m_config], 4);
            break;
          case 4:
            if (test12[m_config][0] < 0) mark_face(-test12[m_config][0]);
            if (test12[m_config][1] < 0) mark_face(-test12[m_config][1]);
            if (test12[m_config][2] > 0) mark_face(test12[m_config][2]);
            draw_triangle(tiling12_1_2[m_config], 8);
            break;
        };
        break;
      ...
      case 13:
        switch (m_subcase) {
          case 0: /* 13.1 */
            draw_triangle(tiling13_1[m_config], 4);
            break;

          case 1: /* 13.2 */
            mark_face(test13[m_config][0]);
            draw_triangle(tiling13_2[m_config][0], 6);
            break;
          case 2: /* 13.2 */
            mark_face(test13[m_config][1]);
            draw_triangle(tiling13_2[m_config][1], 6);
            break;
          case 3: /* 13.2 */
            mark_face(test13[m_config][2]);
            draw_triangle(tiling13_2[m_config][2], 6);
            break;
          case 4: /* 13.2 */
            mark_face(test13[m_config][3]);
            draw_triangle(tiling13_2[m_config][3], 6);
            break;
          case 5: /* 13.2 */
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_2[m_config][4], 6);
            break;
          case 6: /* 13.2 */
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_2[m_config][5], 6);
            break;

          case 7: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            draw_triangle(tiling13_3[m_config][0], 10);
            break;
          case 8: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][3]);
            draw_triangle(tiling13_3[m_config][1], 10);
            break;
          case 9: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_3[m_config][2], 10);
            break;
          case 10: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3[m_config][3], 10);
            break;
          case 11: /* 13.3 */
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][2]);
            draw_triangle(tiling13_3[m_config][4], 10);
            break;
          case 12: /* 13.3 */
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_3[m_config][5], 10);
            break;
          case 13: /* 13.3 */
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3[m_config][6], 10);
            break;
          case 14: /* 13.3 */
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][3]);
            draw_triangle(tiling13_3[m_config][7], 10);
            break;
          case 15: /* 13.3 */
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_3[m_config][8], 10);
            break;
          case 16: /* 13.3 */
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3[m_config][9], 10);
            break;
          case 17: /* 13.3 */
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_3[m_config][10], 10);
            break;
          case 18: /* 13.3 */
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3[m_config][11], 10);
            break;
          ...
          case 19: /* 13.4 */
            ...
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_4[m_config][0], 12);
            break;
          case 20: /* 13.4 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_4[m_config][1], 12);
            break;
          case 21: /* 13.4 */
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_4[m_config][2], 12);
            break;
          case 22: /* 13.4 */
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_4[m_config][3], 12);
            break;
          ...
          case 23: /* 13.5.1 */
            ...
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_5_1[m_config][0], 6);
            break;
          case 24: /* 13.5.1 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_5_1[m_config][1], 6);
            break;
          case 25: /* 13.5.1 */
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_5_1[m_config][2], 6);
            break;
          case 26: /* 13.5.1 */
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_5_1[m_config][3], 6);
            break;
          ...
          case 27: /* 13.5.2 */
            ...
            draw_triangle(tiling13_5_2[m_config][0], 10);
            break;
          case 28: /* 13.5.2 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][5]);
            mark_face(test13[m_config][6]);
            draw_triangle(tiling13_5_2[m_config][1], 10);
            break;
          case 29: /* 13.5.2 */
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][5]);
            mark_face(test13[m_config][6]);
            draw_triangle(tiling13_5_2[m_config][2], 10);
            break;
          case 30: /* 13.5.2 */
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][6]);
            draw_triangle(tiling13_5_2[m_config][3], 10);
            break;
          ...
          case 31: /* 13.3 */
            ...
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3_[m_config][0], 10);
            break;
          case 32: /* 13.3 */
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3_[m_config][1], 10);
            break;
          case 33: /* 13.3 */
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3_[m_config][2], 10);
            break;
          case 34: /* 13.3 */
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_3_[m_config][3], 10);
            break;
          case 35: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3_[m_config][4], 10);
            break;
          case 36: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3_[m_config][5], 10);
            break;
          case 37: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_3_[m_config][6], 10);
            break;
          case 38: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3_[m_config][7], 10);
            break;
          case 39: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3_[m_config][8], 10);
            break;
          case 40: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_3_[m_config][9], 10);
            break;
          case 41: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_3_[m_config][10], 10);
            break;
          case 42: /* 13.3 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            mark_face(test13[m_config][2]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_3_[m_config][11], 10);
            break;
          ...
          case 43: /* 13.2 */
            ...
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_2_[m_config][0], 6);
            break;
          case 44: /* 13.2 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][2]);
            ...
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_2_[m_config][1], 6);
            break;
          case 45: /* 13.2 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            ...
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_2_[m_config][2], 6);
            break;
          case 46: /* 13.2 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            ...
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_2_[m_config][3], 6);
            break;
          case 47: /* 13.2 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            ...
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_2_[m_config][4], 6);
            break;
          case 48: /* 13.2 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            ...
            mark_face(test13[m_config][3]);
            mark_face(test13[m_config][4]);
            draw_triangle(tiling13_2_[m_config][5], 6);
            break;
          case 49: /* 13.1 */
            mark_face(test13[m_config][0]);
            mark_face(test13[m_config][1]);
            ...
            mark_face(test13[m_config][4]);
            mark_face(test13[m_config][5]);
            draw_triangle(tiling13_1_[m_config], 4);
            break;
        }
        break;
...
//-----------------------------------------------------------------------------
{
  ...
  if (button_state != GLUT_DOWN) mouse_rot.mouse_up_handler(x, y, 1);
  ncalls = 0;
...
void display() {
  ...
  */
  ...
  if (fill) {
    // Start rendering...
    if (glIsList(gllist) == GL_TRUE) glCallList(gllist);
  }
...
//-----------------------------------------------------------------------------
{
  switch (key) {
    case GLUT_KEY_LEFT:
      if (m_config <= 0)
        m_config = confsizes[m_case] - 1;
      else
        --m_config;
      break;
    case GLUT_KEY_RIGHT:
      if (m_config >= confsizes[m_case] - 1)
        m_config = 0;
      else
        ++m_config;
      break;
    case GLUT_KEY_DOWN:
      if (m_subcase <= 0)
        m_subcase = subcasesizes[m_case] - 1;
      else
        --m_subcase;
      break;
    case GLUT_KEY_UP:
      if (m_subcase >= subcasesizes[m_case] - 1)
        m_subcase = 0;
      else
        ++m_subcase;
      break;
...
//-----------------------------------------------------------------------------
{
  ...
  /*** Case selection ***/
  case_spin =
      glui->add_spinner("Case", GLUI_SPINNER_INT, &m_case, 0, control_cb);
  case_spin->set_int_limits(0, 14);
  subcase_spin =
      glui->add_spinner("Subcase", GLUI_SPINNER_INT, &m_subcase, 1, control_cb);
  subcase_spin->set_int_limits(0, 49);
  config_spin =
      glui->add_spinner("Config", GLUI_SPINNER_INT, &m_config, 2, control_cb);
