...
// Function pointers
bool FunctionParser::AddFunction(
    const std::string& name, FunctionPtr func, unsigned paramsAmount) {
...
bool FunctionParser::AddFunction(
    const std::string& name, FunctionParser& parser) {
...
// ---------------------
int FunctionParser::Parse(
    const std::string& Function, const std::string& Vars, bool useDegrees) {
  copyOnWrite();
...
int FunctionParser::CompileFunctionParams(
    const char* F, int ind, unsigned requiredParams) {
...
// Compiles ','
int FunctionParser::CompileExpression(
    const char* F, int ind, bool stopAtComma) {
...
void CodeTree::Assemble(
    vector<unsigned>& byteCode, vector<float>& immed) const {
...
SubTree::SubTree(const SubTree& b)
    : tree(new CodeTree(*b.tree)), sign(b.sign) {}
