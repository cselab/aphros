...
#define GFS_VARIABLE_TRACER_VOF_CLASS(klass) \
  GTS_OBJECT_CLASS_CAST(                     \
      klass, GfsVariableTracerVOFClass, gfs_variable_tracer_vof_class())
...
#define GFS_VARIABLE_VOF_CONCENTRATION(obj) \
  GTS_OBJECT_CAST(                          \
      obj, GfsVariableVOFConcentration,     \
...
#define GFS_VARIABLE_TRACER_VOF_HEIGHT(obj) \
  GTS_OBJECT_CAST(                          \
      obj, GfsVariableTracerVOFHeight, gfs_variable_tracer_vof_height_class())
